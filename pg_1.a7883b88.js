...
},{"../dist/chart.js":"../node_modules/chart.js/dist/chart.js"}],"comb.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.indPlot = indPlot;
exports.teamPlot = teamPlot;
...
;
function teamPlot() {
  var kelby_data = loadData("kelby_data");
  var kate_data = loadData("kate_data");
  var zach_data = loadData("zach_data");
  var smack_data = loadData("smack_data");
  var caren_data = loadData("Caren_data");
  var labels = Object.keys(kelby_data); // Months (e.g., "2025-01", "2025-02")
  var kelby_values = Object.values(kelby_data);
  var kate_values = Object.values(kate_data);
  var zach_values = Object.values(zach_data);
  var smack_values = Object.values(smack_data);
  var caren_values = Object.values(caren_data);
  var zelby_data = kelby_values.map(function (num, index) {
    return num + zach_values[index];
  });
  var smatesa_data = kate_values.map(function (num, index) {
    return num + smack_values[index] + kate_values[index];
  });
  var calex_data = caren_values.map(function (num, index) {
    return num + kate_values[index];
  });
  new _auto.default(document.getElementById('tChart'), {
    type: 'bar',
    data: {
      labels: labels,
      // X-axis labels
...
function indPlot() {
  ...
  var smack_values = Object.values(smack_data);
  var caren_values = Object.values(caren_data);
  new _auto.default(document.getElementById('indChart'), {
    type: 'bar',
    data: {
      labels: labels,
      // X-axis labels
...
;
},{"chart.js/auto":"../node_modules/chart.js/auto/auto.js"}],"pg_1.js":[function(require,module,exports) {
"use strict";

var _comb = require("./comb.js");
// PG.1 Main 

(0, _comb.teamPlot)();
},{"./comb.js":"comb.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "61601" + '/');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","pg_1.js"], null)
//# sourceMappingURL=/pg_1.a7883b88.js.map