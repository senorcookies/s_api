...
})({"9H533":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b50e034edb4fe8d1";
"use strict";
...
},{}],"ipU8D":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v4.4.7
...
function teamPlot() {
    ...
    new (0, _chartJs.Chart)(document.getElementById('tChart'), {
        type: 'bar',
        data: {
            labels: labels,
            datasets: [
...
function indPlot() {
    ...
    const smack_values = Object.values(smack_data);
    const caren_values = Object.values(caren_data);
    new (0, _chartJs.Chart)(document.getElementById('indChart'), {
        type: 'bar',
        data: {
            labels: labels,
            datasets: [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"9FYyo","chart.js":"ipU8D"}]},["9H533"], null, "parcelRequire94c2")

//# sourceMappingURL=ind_data.db4fe8d1.js.map
